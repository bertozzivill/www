...
<section class="about">
    ...
    <p class="intro">
        ...
        as a Post-Graduate Fellow at the Institute for Disease Modeling, and has a guest faculty
        position at the UW iSchool.
    </p>
</section>
<section class="visualizations">
    ...
    <div>
        <a style="background-image: url(/assets/img/us_map_thumb.png)" href="http://vizhub.healthdata.org/subnational/usa" target="_blank"></a>
